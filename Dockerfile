...
COPY --from=builder /usr/lib/x86_64-linux-gnu/libfontconfig.so.1 /usr/lib
COPY --from=builder /usr/lib/x86_64-linux-gnu/libfreetype.so.6 /usr/lib
COPY --from=builder /lib/x86_64-linux-gnu/libexpat.so.1 /usr/lib
COPY --from=builder /usr/lib/x86_64-linux-gnu/libuuid.so.1 /usr/lib
COPY --from=builder /usr/lib/x86_64-linux-gnu/libpng16.so.16 /usr/lib
COPY --from=builder /lib/x86_64-linux-gnu/libz.so.1 /usr/lib
COPY --from=builder /usr/lib/x86_64-linux-gnu/libbrotlidec.so.1 /usr/lib
COPY --from=builder /usr/lib/x86_64-linux-gnu/libbrotlicommon.so.1 /usr/lib
